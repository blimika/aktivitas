...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <li>
		<a href="<?php echo $url; ?>/rekappegawai/">Rekap Pegawai</a>
	</li>
	<li class="active">
    ...
    <div class="row">
          <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <h2 class="text-right"><?php echo $r_user["item"][1]["nama"];?></h2> 
                    <h4 class="text-right"><?php echo $JenisJabatan[$r_user["item"][1]["peg_jabatan"]].' '.$r_user["item"][1]["unit_nama"]; ?></h4>
